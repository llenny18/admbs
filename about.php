            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="cta-content">
                        <br>
                        <br>
                        <h2>Learn more <em>About Our Foodpark</em></h2>
                        <p>Introduction</p>
                    </div>
                </div>
            </div>
    ...
    <section class="section" id="our-classes">
        <div class="container">
            ...
            <div class="row" id="tabs">
              <div class="col-lg-4">
                <ul>
                  <li><a href='#tabs-1'><i class="fa fa-history"></i> Our History</a></li>
                  <li><a href='#tabs-2'><i class="fa fa-cutlery"></i> Food Quality</a></a></li>
                  <li><a href='#tabs-3'><i class="fa fa-bookmark"></i> Services</a></a></li>
                </ul>
              </div>
              <div class="col-lg-8">
